...
class User(Base):
    ...
    # Separate from verification_code/is_verified on purpose — resetting a
    # forgotten password must never touch (or be blocked by) the email
    # verification state of an already-verified account.
